...
6. full adder, CLA(compute the carry_{n}), OF(three implementation), *PSWR(Program Status Word Register)/CCR(Condition Code Register)*
7. multiply and divide (too hard, not very clearly)
