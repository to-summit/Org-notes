...
* Shortcuts
    ...
    10) C-c C-x f insert a footnote or type C-c C-o will jump at footnote and text #[fn:1]<<footnote-usage>>
...
to do the reference. We have talked about how to add [[footnote-usage][footnote]](this is a usage of anchor, press C-c C-o will jump to this anchor).
